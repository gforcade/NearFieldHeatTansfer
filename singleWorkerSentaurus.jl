...
function heatLayersFunc(vals::NTuple{15,Float64})
...
values = collect(Iterators.zip(Rad_T,firstgap_d,Rad_d,gap_d,fsf_d,emitter_d,base_d,substrate_d,Rad_dop,fsf_dop,emitter_dop,base_dop,substrate_dop,fsf_As,base_As))
...
asyncmap( i -> heatLayersFunc(i),values)

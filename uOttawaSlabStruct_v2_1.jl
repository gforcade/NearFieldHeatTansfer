# v2_1: to calculate the total heat transfer (includes gold layer)
...
function uOttawaSlabs_v2_1(tEmit::Float64, tBck::Float64, divProtCell::Int, divNCell::Int, divPCell::Int, divSubCell::Int, firstGap::Float64, thckRad::Float64, distGap::Float64, thckProt::Float64, thckInAs::Float64, thckInAsSbP::Float64, thckSub::Float64, ndoping_InAs::Float64, pdoping_InAs::Float64, quat_x::Float64, prot_quat_x::Float64, mboxProt::Float64, mboxN::Float64, mboxP::Float64, mboxSub::Float64,xMinProt::Float64, xMinN::Float64, xMinP::Float64, xMinSub::Float64)
...
### Settings
	...
	# Silicon emitter.
	# Dopant energy (eV) and density (cm-3)
	acpDpt = dptDsc(0.045, 0.0)
	dnrDpt = dptDsc(0.044, 1e19)
	...
	#eps_nInAs_IBimag(enr) = imag(epsIBEV(enr,InAs_param.N0,InAs_param.T,InAs_param.E0_T_InAs_value))
	...
	# InAsSbP protection layer InAsxSbyP(1-x-y)
	...
	eps_InAsSbP_imag_prot(enr) = eps_InAsSbP_imag_xy(enr,InAsSbPstructure_prot)
...
precompile(uOttawaSlabs_v2_1, (Float64, Float64, Int, Int, Int, Int, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64, Float64))
